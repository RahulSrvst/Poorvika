    ...
    <div >
      ...
      <div className="bg-gradient-to-b from-orange-500 to-orange-500 py-1 flex items-center xl:pl-24 md:pl-3 pl-2">
        <img
          ...
          alt="Logo"
          className="xl:h-[10%] lg:h-[12%] lg:w-[17%] md:h-[14%] md:w-[24%] xl:w-[12%] w-[42%]"
        />
        ...
        <div className="flex-grow w-full flex text-white">
          ...
          <div className="flex xl:space-x-20 lg:space-x-10 md:space-x-5 space-x-4">
            ...
            <div className="flex lg:hidden flex-col xl:ml-20 lg:ml-10 md:ml-5 leading-none transform md:pt-1  ">
              <IoLocationSharp className="md:h-7 md:w-7 w-6 h-7 p-1 md:-mt-0.5 -mt-1 lg:ml-0 md:ml-4 ml-[65%] leading-none" />
              <p className="font-medium pt-0.5 lg:flex block text-[12px] md:-mt-1 -mt-2 truncate sm:w-full w-12 md:ml-0 ml-14">LUCKNOW</p>
            </div>
            ...
            <div className="flex leading-none items-center ">
              ...
              <div>
                <MyIcon className="md:h-7 md:w-7 w-6 h-6 transform -scale-x-100 md:-mt-1.5" />
              </div>
            </div>
            ...
            <div className="flex leading-none items-center ">
              ...
              <div>
                <MdAccountCircle className="md:h-8 md:w-8 w-8 h-8 lg:-mt-2 md:-mt-0 md:pt-0 pt-1  " />
              </div>
            </div>
      ...
      <div className="md:flex hidden justify-between font-medium xl:px-32 px-10 xl:text-[16px] md:text-xs xl:py-4 lg:py-3 py-2 rounded-b-lg shadow-2xl mt-12">
          <button>Mobiles & Accessories</button>
          <button>Computer & Tablets</button>
          <button>Mobiles & Audio</button>
